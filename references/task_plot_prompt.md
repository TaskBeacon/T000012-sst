...
Construct: response inhibition / action cancellation
Rows/conditions:
- Go trial: white left/right arrow; press F for left or J for right.
- Stop trial: white arrow starts the go response, then a red arrow stop signal appears after adaptive SSD; withhold response.

Timeline phases:
- Go trial: Fixation (800-1000 ms; no scored response; +) -> Go arrow (1000 ms; press F/J; white left/right arrow) -> Miss feedback (800 ms if no go response; no response; no-response prompt)
- Stop trial: Fixation (800-1000 ms; no scored response; +) -> Pre-stop go (SSD 50-500 ms adaptive; response = stop failure; white arrow) -> Stop signal (remaining go window; withhold response; red arrow)
...
- Preserve these exact terms where used: Go trial, Stop trial, Fixation, Go arrow, Pre-stop go, Stop signal, Miss feedback, F/J, white arrow, red arrow, 800-1000 ms, 1000 ms, SSD 50-500 ms adaptive, remaining go window, withhold response, stop failure, 800 ms.
